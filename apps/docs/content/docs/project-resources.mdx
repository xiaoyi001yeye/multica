...
Despite the internal type name, repository URLs may point to GitHub, GitLab, self-hosted Git, or another Git server. The default branch, role, description, and PR/MR guide are optional execution hints surfaced to the agent.
...
- **Git repository**: https://github.com/multica-ai/multica
  ...
  - Role: backend
  - Default branch: `main`
  - Checkout: `multica repo checkout https://github.com/multica-ai/multica --ref main`
